...
namespace KopSoftPrint
{
    public partial class KopSoftSerialPort : Form
    {
        ...
        //    {
        //        if (checkBox1.Checked && tbShowData.Text.Length > 0)
        //        {
        //            textBox2.AppendText("\r\n");
        //        }

        //        //string NewContent = content.Replace("g", "");
        //        //NewContent = content.Replace("kg", "");

        //        //NewContent = content.Replace("毛重", "");
        //        //NewContent = content.Replace("皮重", "");
        //        //NewContent = content.Replace("净重", "");

        //        textBox2.AppendText(content);
        //        //dataGridView1.Rows[0].Cells[0].Value = content;
        //    }));

        //    //Speech.Instance().Speak(100, -1, "当前车辆" + textBox1.Text.Trim() + "过磅重量为" + textBox2.Text.Trim() + "信息已经记录请放行");
        //}
